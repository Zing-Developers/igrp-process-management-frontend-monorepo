...
export function AvailableTasksContent() {
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {selectedTask.priority ? (
                      <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getPriorityColor(selectedTask.priority?.toString() || '')}`}>
                        {selectedTask.priority}
                      </span>
                    ) : (
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  >
                    <UserPlus className="w-4 h-4" />
                    <span>
                      {claimingTask === selectedTask.id ? 'Atribuindo...' : 'Atribuir Tarefa'}
                    </span>
                  </button>
                </div>
              </div>
