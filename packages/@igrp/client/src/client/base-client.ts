import { ApiClientConfig, ApiResponse } from '@igrp/platform-process-management-types';
...
export class BaseApiClient {
    ...
    protected async post<T>(endpoint: string, body?: any, params?: Record<string, any>): Promise<ApiResponse<T>> {
